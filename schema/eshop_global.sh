#!/bin/bash
# ============================================================
# eshop_global.sh — Schéma global EShop
# Connecté comme APP_USER dans la PDB cible
# ============================================================
echo "[eshop_global.sh] Creating schema as ${APP_USER} on ${ORACLE_DATABASE}..."
...
ALTER TABLE PRODUITS ADD FOREIGN KEY (IDFOUR) REFERENCES FOURNISSEURS (IDFOUR);
ALTER TABLE PRODUITS ADD FOREIGN KEY (IDCATEG) REFERENCES CATEGORIES (IDCATEG);
ALTER TABLE COMMANDES ADD FOREIGN KEY (IDEMPLOYE) REFERENCES EMPLOYES (IDEMPLOYE);
ALTER TABLE COMMANDES ADD FOREIGN KEY (IDCLIENT) REFERENCES CLIENTS (IDCLIENT);
ALTER TABLE LIGNECOMMANDES ADD FOREIGN KEY (IDCOMMANDE) REFERENCES COMMANDES (IDCOMMANDE);
ALTER TABLE LIGNECOMMANDES ADD FOREIGN KEY (IDPRODUIT) REFERENCES PRODUITS (IDPRODUIT);

COMMIT;
EXIT;
SQLEOF

echo "[eshop_global.sh] Done."
