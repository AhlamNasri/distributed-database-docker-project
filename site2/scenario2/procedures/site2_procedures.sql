-- ============================================================
-- SITE 2 - PROCÉDURES STOCKÉES (Scenario 2)
...
BEGIN
    ...
    IF p_qte >= 100 THEN
        RAISE_APPLICATION_ERROR(-20001,
            'SITE2 ERROR: Quantite ' || p_qte || ' >= 100. Cette ligne appartient à Site1.');
    END IF;

    SELECT COUNT(*) INTO v_cmd_count
    FROM COMMANDES2 WHERE IDCOMMANDE = p_idcmd;
    ...
    FROM PRODUITS2 WHERE IDPRODUIT = p_idprod;
